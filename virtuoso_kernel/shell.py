...
class VirtuosoShellClient(object):
    ...
    def init(self, port=None):
        ...
        self.host = "localhost"
        #TODO:
        # This info will come from a JSON file generated by the dfII server
        # So, read JSON to figure out the connection info
        if self.port is None:
            self.port = PYLL_ZMQ_SOCKET
